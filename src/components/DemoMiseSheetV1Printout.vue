...
<template>
  <div class="mise-page">
    <div class="screen-toolbar no-print">
      <button class="toolbar-secondary" @click="back">← Intro</button>
...
.toolbar-secondary:hover { border-color: var(--ep-ink); }
...
/* Mobile responsive — phone-friendly fit */
@media (max-width: 700px) {
  ...
  .sheet-title { font-size: 0.95rem; letter-spacing: 0.14em; }
  .grid-head,
  .grid-row {
    grid-template-columns: 1.3fr 2.7fr;
  }
  .grid-row { min-height: 0.95in; }
  .cambro-svg { width: 1.8rem; height: 0.65in; }
  .cambro-svg-wide { width: 2.4rem; height: 0.4in; }
  .cambro-label { font-size: 0.5rem; }
  .purpose-text { font-size: 0.75rem; }
  .ing-table { font-size: 0.72rem; }
  .ing-table th { font-size: 0.55rem; letter-spacing: 0.14em; }
  .ing-table th,
  .ing-table td { padding: 0.35rem 0.4rem; }
  .extras-grid {
