...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Clicking hero image in CookLogSection opens lightbox at index 0 (first photo), not the hero's array position
- [x] #2 Clicking a thumbnail in the photo strip still opens at that photo's index (existing behavior preserved)
- [x] #3 Arrow/swipe navigation works correctly from index 0
