...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Navigating to index page sets title to "proofed."
- [ ] #2 Navigating to a recipe page sets title to "{Recipe Name} — proofed."
- [ ] #3 Navigating to about page sets title to "About — proofed."
- [ ] #4 Navigating to stats page sets title to "Dashboard — proofed."
- [ ] #5 Navigating to bake-log page sets title to "Cook Log — proofed."
- [ ] #6 Navigating to bake detail sets title to "{Recipe Name} — {date} Bake"
- [ ] #7 Recipe-to-recipe navigation updates title to new recipe name
- [ ] #8 OG meta tags update alongside title for each route
- [ ] #9 Existing useRecipeMeta tests updated to cover route-based title logic
