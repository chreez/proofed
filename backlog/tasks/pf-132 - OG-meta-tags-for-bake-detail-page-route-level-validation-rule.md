...
- [x] #10 #10 `prerender-og.ts` generates static HTML for bake detail pages (`recipe/:id/bake/:date/index.html`) with bake-specific OG tags embedded in the HTML — crawlers see correct title, description, and hero image without executing JavaScript
<!-- AC:END -->
